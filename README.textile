...
* Coffee is good. Coffee must be drunk.
                ...
                If you enjoy Vanadium please <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&amp;hosted_button_id=7779751">buy me</a> a cup of <form\
 id="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post"><input type="hidden" name="cmd" value="_s-xclick"><input type="hidden" name="hosted_but\
ton_id" value="7779751"><input type="image" src="http://vanadiumjs.com/images/coffee-sketch.png" border="0" name="submit" alt="coffee"><img alt="" border="0" src\
="https://www.paypal.com/en_GB/i/scr/pixel.gif" width="1" height="1"></form> or
      	      	<script type="text/javascript">
                  var flattr_url = 'http://www.vanadiumjs.com';
</script>
